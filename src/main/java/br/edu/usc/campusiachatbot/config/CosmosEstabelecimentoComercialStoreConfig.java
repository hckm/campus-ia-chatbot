...
public class CosmosEstabelecimentoComercialStoreConfig {

    @Bean
    public EstabelecimentoComercialStore cosmosEstabelecimentoComercialStore(
        ...
        return new CosmosEstabelecimentoComercialStore(client, properties);
    }
}
